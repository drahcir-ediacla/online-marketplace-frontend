      ...
      <div className="container product-details-body">
        ...
        <div className='row2'>
            ...
            <div className='col-right'>
                <div className='prod-details-title'><span>Baseball Cap Washed Cotton Hat Adjustable Polo Style Plain Solid Blank Dad Men</span></div>
                <div className='prod-details-price'><span>₱230.00</span></div>
                <div><span><b>Condition:</b> New</span></div>
        ...
        <div className='row3'>
            ...
            <div className='product-details'>
                <div className='col-left'>
                    ...
                    <hr />
                    <div className='prod-details-title-desc'><h2>Baseball Cap Washed Cotton Hat Adjustable Polo Style Plain Solid Blank Dad Men</h2></div>
