...
const ItemImgGalleryV2 = ({ gallery }) => {
            ...
            <div className='prod-img-gallery'>
                ...
                <div className='selected-prod-img-container'>
                    <div className="carousel-container">
                        {getMediaType(productImgSrc) === 'image' ? (
                                <ReactImageMagnify
                                    {...{
                                        smallImage: {
                                            alt: 'Product Image',
                        ...
                        ) : getMediaType(productImgSrc) === 'youtube' ? (
                            <div>
                                <iframe width="444" height="444" src={productImgSrc} frameborder="0" allowfullscreen ></iframe>
                            </div>
                        ) : (
...
export default ItemImgGalleryV2;