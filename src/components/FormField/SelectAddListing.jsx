            ...
            <div className="select-category-container">
                <div className="wrapper">
                    <div className="dropdown-category collapsible">
                        <input type="text" id='selectCategory' placeholder='Select Category' readOnly />
                    ...
                    <div className="category-option-list">
                        <ul>
                            ...
                            <li className='main-category'>
                                <div className='category-icon collapsible'><img src={CategoryIcon5} alt="" />Women's Fashion</div>
                            ...
                            <li className='main-category' collapsible>
                                <div className='category-icon collapsible'><img src={CategoryIcon6} alt="" />Men's Fashion</div>
                                {/* <div className='collapsible'></div> */}
                                <ul className='sub-category'>
                                    <li>Bottoms</li>
                                    <li>Tops & Sets</li>
